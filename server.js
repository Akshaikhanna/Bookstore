...
connection.beginTransaction((err) => {
  ...
  connection.query(createAuthorsTableQuery, (err) => {
    ...
    const alterTableQuery =
      "ALTER TABLE Authors ADD COLUMN image_path VARCHAR(255);";
    ...
    INSERT INTO Authors (author_name, birth_year) VALUES
      ('Satyajit Ray', 1980,'https://m.media-amazon.com/images/I/91TCHkU6UrL._SL1500_.jpg'),
      ('Anurag Behar', 1975,''),
